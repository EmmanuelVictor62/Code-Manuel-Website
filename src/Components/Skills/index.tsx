...
const Skills: React.FC<SkillsProps> = ({ toggle }) => {
  return (
    <div className="skills" id="skills" data-toggle={toggle}>
      ...
      <div className="skills__icon-container">
            ...
            <div key={index + 1}>
              {icon.iconPath ? (
                ...
                <div className="skills__icon-wrapper">
                  ...
                  ></i>
                  <p className="skills__icon-name">{icon.iconName}</p>
                </div>
              )}
            </div>
          );
        ...
        <div>
          ...
          <p className="skills__icon-name">GrapQl</p>
        </div>
        ...
        <div>
          ...
          <p className="skills__icon-name">TypeScript</p>
        </div>
        ...
        <div>
          ...
          <p className="skills__icon-name">Figma</p>
        </div>
      </div>
    </div>
  );
