      ...
      <Animate.SlideInRight>
        <div className="about__description-container">
          ...
          <p className="about__description-content">
            ...
            developer with two years of experience working in the web
          ...
          <p className="about__description-content">
            With my strong technical skills and ability to work collaboratively
            in a team, I am confident in my ability to deliver high-quality
            projects that meet the needs and exceed the expectations of clients.
          </p>
          <p className="about__description-content">
            Thank you for taking the time to visit my page, and I look forward
